const InfiniteScroll = () => {
    const languageIcons = [
        ...
        { id: 3, name: "React", src: "/images/react.svg" },
        { id: 4, name: "MySQL", src: "/images/mysql.svg" },
        { id: 5, name: "Vue", src: "/images/vue.svg" },
        { id: 6, name: "JavaScript", src: "/images/javascript.svg" },
        { id: 7, name: "TypeScript", src: "/images/typescript.svg" },
        { id: 8, name: "Node.js", src: "/images/nodejs.svg" },
        { id: 9, name: "Python", src: "/images/python.svg" },
        { id: 10, name: "Java", src: "/images/java.svg" },
        { id: 11, name: "PHP", src: "/images/php.svg" },
        { id: 12, name: "Tailwind", src: "/images/tailwind.svg" },
        { id: 13, name: "Express", src: "/images/expressjs.svg" },
        { id: 14, name: "Next", src: "/images/nextjs.svg" },
        { id: 15, name: "Photoshop", src: "/images/photoshop.svg" },
        { id: 16, name: "Figma", src: "/images/figma.svg" },
    ];
